...
local ROLLOVER_ANGULAR_XY_THRESHOLD_DEGREES = RolloverConfig.angularXYThresholdDegrees or 180.0
local ROLLOVER_ANGULAR_Z_THRESHOLD_DEGREES = RolloverConfig.angularZThresholdDegrees or 180.0
